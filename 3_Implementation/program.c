...
int main()
{
	...
	do
	{
		...
		printf("\n enter\t  4 for update book record");
		printf("\n enter\t  5 for search book record");
		printf("\n *****************student record***************");
		printf("\n enter\t  6 for add student record ");
		printf("\n enter\t  7 for update student record");
		printf("\n enter\t 8 for search student record");
		printf("\n enter\t 9 for delete student record");
		printf("\n enter\t ********** 0 for exit *********");
		printf("\n enter your choice     ");
		scanf("%d",&n);
